...
TEST_CASE("style shets"){

    REQUIRE(Style::getWindowStyleSheet()==
                    "QWidget { "
                       "background-color: #454545; "
                       "border: 1px solid #454545; "
                       "}" );

     REQUIRE(Style::getLabelStyleSheet()==
             "QLabel { "
                        "color: #8f8f8f; "
                        "border: none; "
                        "margin: 6px; "
                        "}");
      REQUIRE(Style::getCloseWindowButtonStyleSheet()==
              "QToolButton { "
                         ...
                         "}" );
       REQUIRE(Style::getMaximizeWindowButtonStyleSheet()==
               "QToolButton { "
                          ...
                          "background-color: #3575ff; "
                          "}");
        REQUIRE(Style::getRestoreWindowButtonStyleSheet()==
                "QToolButton { "
                           ...
                           "background-color: #3575ff; "
                           "}");
        REQUIRE(Style::getMinimizeWindowButtonStyleSheet()==
                "QToolButton { "
                           ...
                           "background-color: #3575ff; "
                           "}");
        REQUIRE(Style::getNextSongButtonStyleSheet()==
                "QToolButton { "
                           ...
                           "}");
        REQUIRE(Style::getPreviousSongButtonStyleSheet()==
                "QToolButton { "
                           ...
                           "}");
         REQUIRE(Style::getStopButtonStyleSheet()==
                 "QToolButton { "
                            ...
                            "}");
         REQUIRE(Style::getPlayButtonStyleSheet()==
                 "QToolButton { "
                            ...
                            "}");
          REQUIRE(Style::getShuffleButtonStyleSheet()==
                  "QToolButton { "
                             ...
                             "}");
           REQUIRE(Style::getSequentialButtonStyleSheet()==
                   "QToolButton { "
                              ...
                              "}");
            REQUIRE(Style::getPauseButtonStyleSheet()==
                    "QToolButton { "
                               ...
                               "}");
            REQUIRE(Style::getPlaylistTableViewStyleSheet()==
                  "QTableView { "
                               "background-color: #454545; "
                               "color: #adadad; "
                               "border: 4px  #454545;"
                               ...
                               "padding: 6px; "
                               "}");
             REQUIRE(Style::getAddSongButtonStyleSheet()==
                     "QToolButton { "
                                ...
                                "background-color: #3575ff; "
                                "}");
             REQUIRE(Style::getRemoveSongButtonStyleSheet()==
                     "QToolButton { "
                                ...
                                "background-color: #3575ff; "
                                "}");
              REQUIRE(Style::getSliderStyleSheet()==
                      "QSlider::groove:horizontal {"
                               ...
                               "background: #eee;"
                               "}");
              REQUIRE(Style::getVerticalScrollBarStyleSheet()==
                      "QScrollBar::groove:vertical {"
                              ...
                              "    subcontrol-origin: margin;"
                              "}");
               REQUIRE(Style::getHorizontalScrollBarStyleSheet()==
